...
public class MyCustomAdapter1 extends ArrayAdapter<CalorieCount> {

    private Context context;
    private List<CalorieCount> FoodItem;
    private List<CalorieCount> FoodItemFiltered;

    public MyCustomAdapter1( Context context, List<CalorieCount> FoodItem) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_custom_items1,null,true);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Calories.calorieCountList= (List<CalorieCount>) results.values;
